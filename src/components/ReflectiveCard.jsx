      ...
      <div
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center z-10">
          <img
            src={profilePicture}
            alt="Profile"
            className="rounded-full w-32 h-32 border-4 border-white/20 object-cover"
          />
        </div>
        <div
          className="flex-1 flex flex-col justify-end items-center text-center gap-6 mb-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold tracking-[0.05em] m-0 mb-2 drop-shadow-md">JOMEL A. ANG</h2>
            <p className="text-xs tracking-[0.2em] opacity-70 m-0 uppercase">SOFTWARE ENGINEER</p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-end border-t border-white/20 pt-6">
          <div className="flex flex-col gap-1">
            ...
            <span className="font-mono text-sm tracking-[0.05em]">2026-0302-0310</span>
          </div>
